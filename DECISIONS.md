...
M0 技术架构设计与 M1 工程基础已经完成。T-0201 至 T-0204 已实现 Maven 检测、受限离线模型、属性与模块层级分析；字段保留 raw/resolved 值、解析状态、SourceLocation 和结构化 Diagnostic。当前下一任务是 T-0205 Dependency Extraction。
...
> 完成 T-0205 — Dependency Extraction。
