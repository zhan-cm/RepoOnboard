...
>
> Maven 分析、Java 源码 facts 和已确认的标准 Spring 组件识别已经可用。下一步是配置类与应用入口识别，首个可用版本尚未发布。
...
当前 CLI 已提供 Maven、Java 源码和带来源证据的标准 Spring 组件分析。Spring 配置/应用入口、注入、API、依赖图和 Web UI 仍在开发中。
