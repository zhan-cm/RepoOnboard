...
- **T-1003** 已完成；中英文 README 已按 `0.1.0-SNAPSHOT` 状态重写，覆盖源码安装、内置 fixture 演示、实际功能、支持范围、PARTIAL 语义、验证证据、已知限制、路线及贡献/License 边界，并在当时明确尚无 Release、release tag 或项目 License；项目 License 后由 T-1006 补齐。
